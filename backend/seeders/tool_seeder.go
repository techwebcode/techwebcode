...
func SeedTools(db *gorm.DB) error {
	...
	approvedSlugs := []string{
		...
		"json-formatter",
		"yaml-formatter-and-kubernetes-secret-tool",
		"yaml-formatter",
		"json-validator",
		"json-minifier",
		"jwt-decoder",
	...
	toolsData := []ToolSeedData{
		{
			...
			CategorySlug:     "json",
			ShortDescription: "Format, validate, beautify, and inspect JSON data instantly.",
			Description:      "Free online JSON Formatter & Validator. Format, validate, and inspect JSON payload structure instantly in your browser with 100% client-side data privacy.",
			Icon:             "FileCode",
			Featured:         true,
			Popular:          true,
			IsNew:            false,
			SortOrder:        1,
			Status:           true,
			SeoTitle:         "Free Online JSON Formatter & Validator | TechWebCode",
		...
		},
		{
			...
			Slug:             "yaml-formatter-and-kubernetes-secret-tool",
			CategorySlug:     "web",
			ShortDescription: "Validate YAML syntax, format Kubernetes manifests, and decode Base64 secrets.",
			Description:      "Free online YAML Formatter & Kubernetes Secret Tool. Validate YAML manifests, convert JSON/YAML, and decode Kubernetes Secret data payloads instantly.",
			Icon:             "FileText",
			Featured:         true,
			Popular:          true,
			IsNew:            true,
			SortOrder:        3,
			Status:           true,
			SeoTitle:         "Free Online YAML Formatter & Kubernetes Secret Tool | TechWebCode",
			SeoDescription:   "Validate YAML syntax, format K8s manifests, and decode Base64 Kubernetes Secrets online.",
		},
		{
			Name:             "YAML Formatter",
			Slug:             "yaml-formatter",
			CategorySlug:     "web",
			ShortDescription: "Format and validate YAML files and Kubernetes configuration manifests.",
			Description:      "Free online YAML Formatter & Validator. Validate YAML syntax and format Kubernetes configuration files with instant line error checking.",
			Icon:             "FileText",
			Featured:         true,
			Popular:          false,
			IsNew:            true,
			SortOrder:        4,
			Status:           true,
			SeoTitle:         "Free Online YAML Formatter | TechWebCode",
			SeoDescription:   "Format and validate YAML syntax online with privacy-first client-side parsing.",
		},
		{
			Name:             "JSON Validator",
			Slug:             "json-validator",
