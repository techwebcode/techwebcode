...
interface Props {
  onFormat(): void;
  onDecodeSecrets(): void;
  onEncodeSecrets(): void;
  onToJson(): void;
  onLoadSample(): void;
...
export default function YamlFormatterToolbar({
  onFormat,
  onDecodeSecrets,
  onEncodeSecrets,
  onToJson,
  ...
  return (
    <div className="flex flex-wrap items-center justify-between gap-3 rounded-2xl border bg-card p-3 shadow-sm">
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        <Button
          variant="outline"
          onClick={onDecodeSecrets}
          className="rounded-xl gap-2 text-xs font-medium border-emerald-500/30 text-emerald-600 dark:text-emerald-400 hover:bg-emerald-500/10"
        >
        ...
        <Button
          variant="outline"
          onClick={onEncodeSecrets}
          className="rounded-xl gap-2 text-xs font-medium border-blue-500/30 text-blue-600 dark:text-blue-400 hover:bg-blue-500/10"
        >
          <Lock className="h-3.5 w-3.5" />
          Encode K8s Secrets
        </Button>

        <Button variant="secondary" onClick={onToJson} className="rounded-xl gap-2 text-xs font-medium">
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        <YamlFileUpload onLoad={onFileUpload} />
