...
export default function ToolHero({ onSearch }: ToolHeroProps) {
  return (
    <section className="border-b bg-gradient-to-b from-background via-muted/20 to-muted/30 py-8 lg:py-10">
      <Container className="text-center space-y-4 max-w-4xl">
        ...
        <p className="mx-auto max-w-2xl text-sm sm:text-base text-muted-foreground leading-relaxed">
          Fast, privacy-first developer tools that run directly in your browser.
        </p>
