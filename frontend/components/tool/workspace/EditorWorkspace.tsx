...
export default function EditorWorkspace({
  ...
  // Body scroll locking & scroll position restoration
  useEffect(() => {
    if (!isOpen) return;
  ...
  return createPortal(
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-label={title || "Expanded Editor Workspace"}
    >
      {/* Viewport-Level Editor Header Toolbar */}
      <div className="flex items-center justify-between gap-4 px-4 sm:px-6 py-3 border-b border-slate-800 bg-slate-900/95 shrink-0 select-none">
        ...
        <div className="flex items-center gap-2.5 shrink-0">
          ...
          <Button
            ...
            aria-label="Exit expanded editor workspace"
          >
      ...
      {/* Dynamic Viewport Editor Workspace Body */}
