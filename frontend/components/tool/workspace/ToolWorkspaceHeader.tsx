      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-1.5 flex-wrap">
          ...
          <Button
            ...
            className="h-8 px-3 rounded-lg border-blue-500/30 bg-blue-500/10 text-blue-600 dark:text-blue-400 hover:bg-blue-600 hover:text-white dark:hover:bg-blue-600 dark:hover:text-white text-xs font-extrabold gap-1.5 transition-all shadow-2xs"
            title="Full Screen Workspace (Distraction Free)"
          >
            <Maximize2 className="h-3.5 w-3.5" />
            <span className="inline-flex">Full Screen Workspace</span>
          </Button>
        </div>
      </div>
    </header>
